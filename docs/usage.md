# nf-core/dragen: Usage

## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/dragen/usage](https://nf-co.re/dragen/usage)
...
First, go to the [nf-core/dragen releases page](https://github.com/nf-core/dragen/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
